...
import com.xihh.base.android.BaseSheetDialogFragment

open class CommonDialogFragment : BaseSheetDialogFragment<DialogCommonBinding>() {
    ...
    private var cancelInvoke: (CommonDialogFragment.() -> Unit)? = null
    ...
    private var confirmInvoke: (CommonDialogFragment.() -> Unit)? = null
    ...
    fun onConfirm(
        confirmRes: Int,
        block: CommonDialogFragment.() -> Unit = { this.dismiss() },
    ): CommonDialogFragment {
    ...
    fun onConfirm(
        block: CommonDialogFragment.() -> Unit,
    ): CommonDialogFragment {
    ...
    fun onCancelBg(@DrawableRes cancelBgRes: Int): CommonDialogFragment {
        this.cancelBgRes = cancelBgRes
        return this
    }

    fun onConfirmBg(@DrawableRes confirmBgRes: Int): CommonDialogFragment {
        this.confirmBgRes = confirmBgRes
        return this
    }

    fun padding(topPadding: Int? = null, bottomPadding: Int? = null): CommonDialogFragment {
